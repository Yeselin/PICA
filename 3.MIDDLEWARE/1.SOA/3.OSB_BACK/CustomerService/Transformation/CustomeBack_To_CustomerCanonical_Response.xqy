...
declare namespace ns1="http://xmlns.oracle.com/pcbpel/adapter/db/sp/dbCreateCustomer";
...
declare function local:func($Input as element() (:: schema-element(ns1:OutputParameters) ::)) as element() (:: schema-element(ns2:createCustomerResponse) ::) {
