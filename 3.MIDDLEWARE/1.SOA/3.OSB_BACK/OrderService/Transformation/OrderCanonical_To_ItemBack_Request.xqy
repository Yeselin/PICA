...
declare function local:func($Input as element() (:: schema-element(ns1:createOrderRequest) ::)) as element() (:: schema-element(ns2:InputParameters) ::) {
    <ns2:InputParameters>
       ...
       <ns2:P_PRICE_ITEM>{fn:data($Input/ns1:order/ns1:product/pro:cost)}</ns2:P_PRICE_ITEM>
       ...
       <ns2:P_ITEM_STATUS_NAME>{fn:data($Input/ns1:order/ns1:product/pro:productName)}</ns2:P_ITEM_STATUS_NAME>
    </ns2:InputParameters>
};
